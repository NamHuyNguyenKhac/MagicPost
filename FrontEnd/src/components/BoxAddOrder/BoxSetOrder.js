...
function BoxSetOrder() {
  ...
  const handlePrintPack = () => {
        navigate("/packedid=100029885952241");
  }
  ...
  return (
    <div className="boxAddOrderWrapper">
      <div className="boxAddOrder">
        ...
        <div className="btnWrapper_BAO22">
          <button className="btn_BAO22" onClick={handlePrintPack}>
            Print
          </button>

          <button className="btn_BAO22" onClick={handleSaveBtnClicked}>
            Save
          </button>

          <button className="btn_BAO22" onClick={handleCancelBtnClicked}>
            Cancel
          </button>
        </div>
      </div>
