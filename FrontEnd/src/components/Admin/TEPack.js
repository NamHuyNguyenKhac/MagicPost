...
import HeaderTE from "../Header/HeaderTE.js";
    ...
    <div className="GWrapper">
      <div className="AllTellerWrapper">
        ...
        <div className="tableWrapper_TELLER">
          {/* Bang Trading Point */}
          {topStatus === "Trading Point" && <ICMOrderTable></ICMOrderTable>}

          {/* Bang Gathering Point */}
          {topStatus === "Gathering Point" && <OrderTable></OrderTable>}
