...
import { faTable, faUser, faChartSimple, faCircleUser, faLocationDot } from '@fortawesome/free-solid-svg-icons';
import './Header.css';
    ...
    return (
        ...
        <div className='headerTab'>
            ...
            <button className='ForgotPasswordTabBtn' onClick={handleForgotTabBtnHomeClick}>
                ...
                <div className='TextForgotPasswordTabBtn'>Points</div>
            </button>
            {/* Nut Search */}
            <button className='ForgotPasswordTabBtn' onClick={handleForgotTabBtnSearchClick}>
            <FontAwesomeIcon icon={faCircleUser} />
                <div className='TextForgotPasswordTabBtn'>Leader</div>
            </button>
            {/* Nut Profile */}
